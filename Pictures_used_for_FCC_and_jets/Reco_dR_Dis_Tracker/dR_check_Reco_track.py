    ...
    for j in range(2):
        for i in range(5):
            ...
            for iii in range(int(myTree_QQ.GetEntriesFast())):
                ...
                A      = myTree_QQ.dR_Tr1T_HPt_Reco_track
            ...
            for iii in range(int(myTree_WW.GetEntriesFast())):
                ...
                A      = myTree_WW.dR_Tr1T_HPt_Reco_track
            ...
            c.Print(str(energy[E])+"TeV_Reco_track/dR_"+str(list_PT_T[j])+"_"+str(i)+"_"+str(energy[E])+"TeV_Reco.pdf")
